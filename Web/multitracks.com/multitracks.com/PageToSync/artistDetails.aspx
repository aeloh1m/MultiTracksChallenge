...
<body class="premium standard u-fix-fancybox-iframe">
    <form>
        ...
        <!-- Checking for invalid artist -->
        <h1 runat="server" id="invalidArtist">An error has occurred! Seems like the artist entered is invalid.

        </h1>
        <!-- Data displaying from server -->
        <div runat="server" id="displayData" class="wrapper mod-standard mod-gray">
